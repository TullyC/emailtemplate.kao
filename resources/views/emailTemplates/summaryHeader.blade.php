	...
	<tr style="height:150px;" >
		...
		<td style="padding:0;">
			<table class="dealer_info_wrap" style="padding:0;height:150px;" >
				...
				<tr style="width:300px; display:block; padding:0; height:100px;">
					<td style="display:inline-block; padding:0;">
						<img class="big_dealer_logo" src="/default.jpg" alt="Dealer Logo">
					</td>					
				</tr>	
				<tr  style="display:block; height:50px; padding:0;" >
					<td style="display:block; height:50px; padding:0;">
						<p style="width:50%;padding:0; padding-left:10px;display: inline-block; ">{ dealership }</p>
						<img  class="little_dealer_logo" src="/default.jpg" alt="Dealer Logo"/>
